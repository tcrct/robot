...
import com.robot.agv.vehicle.exchange.commands.*;
...
/**
 * Implements the gui of the example vehicle control and visualizes the status of protocol data.
 *
...
public class ControlPanel
   ...
   */
  private RobotProcessModelTO processModel;
   ...
   */
  @Inject
  public ControlPanel(@Assisted RobotProcessModelTO processModel,
  ...
  private void initGuiContent() {
    ...
    for (RobotProcessModel.Attribute attribute : RobotProcessModel.Attribute.values()) {
      processModelChange(attribute.name(), processModel);
    }
  }
  ...
  public void processModelChange(String attributeChanged, VehicleProcessModelTO newProcessModel) {
    if (!(newProcessModel instanceof RobotProcessModelTO)) {
      return;
    }
    processModel = (RobotProcessModelTO) newProcessModel;
    ...
    else if (Objects.equals(attributeChanged, RobotProcessModel.Attribute.VEHICLE_HOST.name())) {
      updateVehicleHost(processModel.getVehicleHost());
    }
    else if (Objects.equals(attributeChanged, RobotProcessModel.Attribute.VEHICLE_PORT.name())) {
      updateVehiclePort(processModel.getVehiclePort());
    }
    else if (Objects.equals(attributeChanged,
            RobotProcessModel.Attribute.VEHICLE_IDLE_TIMEOUT.name())) {
      updateVehicleTimeout(processModel.getVehicleIdleTimeout());
    }
    else if (Objects.equals(attributeChanged, RobotProcessModel.Attribute.VEHICLE_IDLE.name())) {
      updateVehicleIdle(processModel.isVehicleIdle());
    }
    else if (Objects.equals(attributeChanged,
            RobotProcessModel.Attribute.DISCONNECTING_ON_IDLE.name())) {
      updateDisconnectingOnIdle(processModel.isDisconnectingOnVehicleIdle());
    }
    else if (Objects.equals(attributeChanged,
            RobotProcessModel.Attribute.RECONNECTING_ON_CONNECTION_LOSS.name())) {
      updateReconnectingOnConnectionLoss(processModel.isReconnectingOnConnectionLoss());
    }
    else if (Objects.equals(attributeChanged, RobotProcessModel.Attribute.LAST_ORDER.name())) {
      updateLastOrder(processModel.getLastOrderSent(), processModel.isCommAdapterConnected());
    }
    else if (Objects.equals(attributeChanged,
            RobotProcessModel.Attribute.LOGGING_ENABLED.name())) {
  ...
  private void initComponents() {
    ...
    java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("config/commadapter/Bundle"); // NOI18N
    ...
    connectedButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/config/commadapter/res/symbols/LEDGray.gif"))); // NOI18N
    connectedButton.setText(bundle.getString("AdapterConnected")); // NOI18N
    connectedButton.setBorderPainted(false);
    connectedButton.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/config/commadapter/res/symbols/LEDRed.gif"))); // NOI18N
    connectedButton.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/config/commadapter/res/symbols/LEDGreen.gif"))); // NOI18N
  ...
  activeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/config/commadapter/res/symbols/LEDGray.gif"))); // NOI18N
  activeButton.setText(bundle.getString("ControlPanel.AdapterActive")); // NOI18N
  activeButton.setBorderPainted(false);
  activeButton.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/config/commadapter/res/symbols/LEDRed.gif"))); // NOI18N
  activeButton.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/config/commadapter/res/symbols/LEDGreen.gif"))); // NOI18N
