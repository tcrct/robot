...
/**
 * A custom model for the {@link RobotCommAdapter} which holds additional information
...
public class RobotProcessModel extends VehicleProcessModel {
   ...
   */
  public RobotProcessModel(Vehicle attachedVehicle) {
    super(attachedVehicle);
    // Initialize the state fields
    previousState = new StateResponse(new Protocol.Builder().build());
    currentState = new StateResponse(new Protocol.Builder().build());
  }
