 ...
 */
public class RobotCommAdapterPanelFactory
    implements VehicleCommAdapterPanelFactory {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(RobotCommAdapterPanelFactory.class);
  /**
   * The service portal.
   */
  ...
  public List<VehicleCommAdapterPanel> getPanelsFor(
    ...
    panels.add(componentsFactory.createControlPanel((RobotProcessModelTO) processModel,
                                                    servicePortal.getVehicleService()));
    panels.add(componentsFactory.createStatusPanel((RobotProcessModelTO) processModel,
                                                   servicePortal.getVehicleService()));
    return panels;
  }
  ...
  private boolean providesPanelsFor(VehicleCommAdapterDescription description,
    ...
    return (description instanceof RobotCommAdapterDescription)
        && (processModel instanceof RobotProcessModelTO);
  }
}
